...
(() => {
  ...
  function WorkbenchPage({ route, shell, navigate, onMutate }) {
    ...
    const studioResumeHref = !isStudio || draftId || explicitStudioIntent || resumeTarget.kind !== "draft" || !resumeTarget.href ? null : String(resumeTarget.href);
