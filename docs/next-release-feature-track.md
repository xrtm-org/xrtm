...
> The published baseline is `xrtm==0.8.7`: guided onboarding helpers,
...
>
> This release is deterministic parity-and-verification work unless separate
> real-runtime validation widens it. The published `0.8.7` baseline does not
...
## Released 0.8.7 parity-and-verification train
