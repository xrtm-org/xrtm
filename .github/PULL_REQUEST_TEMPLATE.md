...
- [ ] Provider-free clean-room evidence recorded when published-surface or release-readiness behavior changed (CI release-validation artifact or stack `acceptance-studies/docker-deterministic/.../summary.json`)
...
- Release clean-room evidence: <!-- deterministic workflow artifact / summary.json path, local-LLM note if applicable, or N/A -->
