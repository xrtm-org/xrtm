...
That CSV flag is now part of the published `xrtm==0.7.1` surface. Use this example when you want a **custom data pipeline** or a reusable Python integration surface beyond the built-in one-off CLI export from the [Operator Runbook](../../../docs/operator-runbook.md).
